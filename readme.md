...
- **Components**: Deep knowledge in Illuminate, League, Spatie and Symfony Components.
...
- **Docker**: Experienced in containerizing applications and managing scalable deployments.
- **Stripe**: Stripe Certified Professional Developer.
